...
public final class NewDonorReciept_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<header> Add Blood Bank</header>\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t<fieldset>\t\t\t\t\t\n");
      out.write("\t\t\t\t\t<section>\n");
      out.write("\t\t\t\t\t\t<label class=\"input\">\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" placeholder=\"Name of the organisation\">\n");
      out.write("\t\t\t\t\t\t\t<b class=\"tooltip tooltip-bottom-right\">Only english characters and numbers</b>\n");
      out.write("\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t\t\t</section>\n");
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t\t<section>\n");
