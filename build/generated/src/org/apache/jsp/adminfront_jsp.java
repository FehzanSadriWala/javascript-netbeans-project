...
public final class adminfront_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<header>Admin Panel</header>\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t<fieldset>\t\t\t\t\t\n");
      out.write("                                    <center>\t\n");
      out.write("\t\t\t\t<footer>\n");
      out.write("\t\t\t\t\t<button type=\"submit\" class=\"button\">Add Blood Bank</button>\n");
      out.write("\t\t\t\t</footer>\n");
      out.write("                                \n");
      out.write("                                <footer>\n");
      out.write("\t\t\t\t\t<button type=\"submit\" class=\"button\">Delete Blood Bank</button>\n");
      out.write("\t\t\t\t</footer>\n");
      out.write("                                \n");
      out.write("                                <footer>\n");
      out.write("\t\t\t\t\t<button type=\"submit\" class=\"button\">Manage Inventory</button>\n");
      out.write("\t\t\t\t</footer>\n");
      out.write("                                    </center>\n");
      out.write("\t\t\t</form>\n");
      out.write("\t\t\t\n");
