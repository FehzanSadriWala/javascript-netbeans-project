...
public final class newSearch_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<header>Search panel</header>\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t<fieldset>\t\t\t\t\t\n");
      out.write("\t\t\t\t\t<section>\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<option value=\"1\">GBH</option>\n");
      ...
      out.write("\t\t\t\t\t\t<label class=\"select\">\n");
      out.write("\t\t\t\t\t\t\t<select>\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"0\" selected disabled>Blood Group</option>\n");
      ...
      out.write("                                                                <option value=\"5\">O+</option>\n");
      out.write("                                                                <option value=\"6\">O-</option>\n");
      ...
      out.write("                                                    <input type=\"number\" placeholder=\"Quantity\">\n");
      out.write("\t\t\t\t\t\t\t<b class=\"tooltip tooltip-bottom-right\">Enter the amount of blood units you want</b>\n");
      out.write("\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t\t\t</section>\n");
      out.write("\t\t\t\t\t\n");
      out.write("\n");
