...
public final class AdminManage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<html>\n");
      out.write("\t<head>\n");
      out.write("\t\t<title>Sky Forms</title>\n");
      ...
      out.write("\t\t\t\t<header>Manage Inventory</header>\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t<fieldset>\n");
      out.write("                                <section>\n");
      out.write("\t\t\t\t\t\t<label class=\"select\">\n");
      out.write("\t\t\t\t\t\t\t<select>\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"0\" selected disabled>Available Blood Banks</option>\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"1\">G.B.H</option>\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"2\">Maa Gayatri</option>\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"3\">R.N.T</option>\n");
      out.write("\t\t\t\t\t\t\t</select>\n");
      out.write("\t\t\t\t\t\t\t<i></i>\n");
      out.write("\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t        </section>\n");
      out.write("                        \n");
      out.write("\t\t\t\n");
      out.write("                        <td><input type=\"submit\" value=\"View\" style=\"color:black;margin-top: 20px; width:150px; height:30px; font-size: small; margin-left: 320%\"></td>\n");
      out.write("                        <td><input type=\"submit\" value=\"Add Blood Batches\" style=\"color:black;margin-top: 20px; width:150px; height:40px; font-size: large; margin-left: 380%\"></td>\n");
      out.write("                       <td>&emsp;&emsp;<input type=\"submit\" value=\"Delete Batches\" style=\"color:black;margin-top: 20px; width:150px; height:40px; font-size: large; margin-left: 380%\"></td>\n");
      out.write("             \n");
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t\t<section>\n");
      out.write("\t\t\t\t\t\t<label class=\"input\">\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" placeholder=\"Address\">\n");
      out.write("\t\t\t\t\t\t\t<b class=\"tooltip tooltip-bottom-right\">Address needed for future use</b>\n");
      out.write("\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t\t\t</section>\n");
      out.write("\t\t\t\t\t\n");
      out.write("\t\t                       <section>\n");
      out.write("\t\t\t\t\t\t<label class=\"input\">\n");
      out.write("\t\t\t\t\t\t\t<input type=\"number\" placeholder=\"Contact Number\">\n");
      out.write("\t\t\t\t\t\t\t<b class=\"tooltip tooltip-bottom-right\">Contact number is needed for future use</b>\n");
      out.write("\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t\t\t</section>             \n");
      out.write("                                    \n");
      out.write("                                  \n");
      ...
      out.write("\t\t\t\t\t\t<label class=\"select\">\n");
      out.write("\t\t\t\t\t\t\t<select>\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"0\" selected disabled>Type</option>\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"1\">NGO</option>\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"2\">GOVT.</option>\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"3\">Private</option>\n");
      out.write("\t\t\t\t\t\t\t</select>\n");
      out.write("\t\t\t\t\t\t\t<i></i>\n");
      out.write("\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t\t\t</section>\n");
      ...
      out.write("                                        <section>\n");
      out.write("\t\t\t\t\t\t<label class=\"input\">\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" placeholder=\"Location\">\n");
      out.write("\t\t\t\t\t\t\t<b class=\"tooltip tooltip-bottom-right\">Our users will search blood bank with the location provided </b>\n");
      out.write("\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t\t\t</section>\n");
      out.write("\t\t\t\t\t\t<label class=\"input\">\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" placeholder=\"No. of Batches\">\n");
      out.write("\t\t\t\t\t\t\t<b class=\"tooltip tooltip-bottom-right\">No. of Blood batches that you will add to our organization </b>\n");
      out.write("\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t\t\t</section>\n");
      out.write("\t\t\t\t\t</fieldset>\n");
      out.write("\t\t\t\t<footer>\n");
