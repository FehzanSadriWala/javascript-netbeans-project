...
public final class donordetailsss_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\n");
      out.write("\t\t\t<form action=\"Dbean.jsp\" class=\"sky-form\">\n");
      out.write("                            <header>Donor Details</header>\n");
      out.write("                            <fieldset>\t\n");
      ...
      out.write("\t\t\t\t\t<section>\n");
      out.write("\t\t\t\t\t\t<label class=\"input\">\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"wt\" placeholder=\"Weight\">\n");
      ...
      out.write("\t\t\t\t\t<section>\n");
      out.write("\t\t\t\t\t\t<label class=\"input\">\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"add\" placeholder=\"Address\">\n");
      out.write("\t\t\t\t\t\t\t<b class=\"tooltip tooltip-bottom-right\">Only latin characters and numbers</b>\n");
      out.write("\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t\t\t</section>\n");
      out.write("\t\t\t\t\t\n");
      ...
      out.write("                                    <section>\n");
      out.write("\t\t\t\t\t\t<label class=\"input\">\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"cno\" placeholder=\"Contact No.\">\n");
      out.write("\t\t\t\t\t\t\t<b class=\"tooltip tooltip-bottom-right\">Only latin characters and numbers</b>\n");
      out.write("\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t\t\t</section>\n");
      out.write("                                    \n");
      out.write("                                    <section>\n");
      out.write("\t\t\t\t\t\t<label class=\"input\">\n");
      out.write("\t\t\t\t\t\t\t<input type=\"date\" name=\"ddt\" placeholder=\"Donation Date\">\n");
      out.write("\t\t\t\t\t\t\t<b class=\"tooltip tooltip-bottom-right\">Only latin characters and numbers</b>\n");
      out.write("\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t\t\t</section>\n");
      out.write("                                    \n");
      ...
      out.write("\t\t\t\t\t\t<label class=\"select\">\n");
      out.write("\t\t\t\t\t\t\t<select>\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"0\" selected disabled>Blood Type</option>\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"1\" name=\"bt\">A+</option>\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"2\" name=\"bt\">A-</option>\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"3\" name=\"bt\">B+</option>\n");
      out.write("                                                                <option value=\"4\"name=\"bt\">B-</option>\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"5\" name=\"bt\">O+</option>\n");
      out.write("                                                                <option value=\"6\" name=\"bt\">O-</option>\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"7\" name=\"bt\">AB+</option>\n");
      out.write("                                                                <option value=\"8\" name=\"bt\">AB-</option>\n");
      out.write("                                                        </select>\n");
      out.write("\t\t\t\t\t\t\t<i></i>\n");
      out.write("\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t\t\t</section>\n");
      ...
      out.write("\t\t\t\t\t\t<label class=\"select\">\n");
      out.write("\t\t\t\t\t\t\t<select>\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"0\" selected disabled>Location</option>\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"1\" name=\"loc\">G.B.H.</option>\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"2\" name=\"loc\">Maa Gayatri</option>\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"3\" name=\"loc\">Other</option>\n");
      out.write("\t\t\t\t\t\t\t</select>\n");
      out.write("\t\t\t\t\t\t\t<i></i>\n");
      out.write("\t\t\t\t\t\t</label>\n");
      out.write("\t\t\t\t\t</section>\n");
